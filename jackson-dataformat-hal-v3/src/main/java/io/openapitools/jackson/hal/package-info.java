 ...
 * by adding a Jackson module to the Jackson {@link tools.jackson.databind.ObjectMapper}:
 * <pre>
 * JsonMapper jm = JsonMapper.builder().addModule(new JacksonHALModule()).build();
 * </pre>
 *
 ...
 * relationships. Adding a link is done by creating a property of type {@link io.openapitools.jackson.dataformat.hal.HALLink} annotated with
