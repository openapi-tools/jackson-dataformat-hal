...
public class HALBeanDeserializerJsonViewIT {
    ...
    public void testDeserializationOfView() throws IOException {
        TopResource tr = HALMapper.builder()
            .configure(MapperFeature.DEFAULT_VIEW_INCLUSION, false)
            .build()
            .reader()
            .withView(ResourceView1.class)
            .forType(TopResource.class)
            .readValue(new StringReader(HAL_DOC_INCLUSIVE_VIEW));
    ...
    public void testDeserializationOfNoView() throws IOException {
        TopResource tr = HALMapper.create().readValue(new StringReader(HAL_DOC_NO_VIEW), TopResource.class);
