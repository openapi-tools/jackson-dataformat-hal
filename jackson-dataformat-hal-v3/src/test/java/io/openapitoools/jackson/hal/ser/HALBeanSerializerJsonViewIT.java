...
import static io.openapitoools.jackson.hal.JsonTestUtils.assertJsonEquals;
...
public class HALBeanSerializerJsonViewIT {
    ...
    public void testSerializationOfView() throws Exception {
        ...
        String json = HALMapper.builder()
            .configure(MapperFeature.DEFAULT_VIEW_INCLUSION, false)
            .build()
            .writer()
            .withView(ResourceView1.class)
    ...
    public void testSerializationOfViewWithInclusion() throws Exception {
        ...
        // Use order-agnostic comparison to avoid brittleness from Jackson version differences
    ...
    public void testSerializationOfNoView() throws Exception {
        TopResource res1 = new TopResource();
        String json = HALMapper.create().writeValueAsString(res1);
